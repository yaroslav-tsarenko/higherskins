...
export const metadata = { title: "Cookie Policy — Higherskins" };
...
export default function CookiePolicyPage() {
  return (
    <PolicyLayout title="Cookie Policy" lastUpdated="29 May 2026">
      ...
      <ul>
        <li>first-party cookies, set directly by Higherskins; or</li>
      ...
      <p>
        8.2 These cookies may be set by Higherskins or by third-party advertising and marketing partners.
      </p>
      <p>
      ...
      <p>9.4 Higherskins does not store your full card number or full card security code.</p>
